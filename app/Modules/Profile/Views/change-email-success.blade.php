...
<head>
    ...
    <title>Email Changed - SK Kabataan</title>
    @vite([
        ...
        <div class="youth-signin-section">
            <div class="youth-signin-card">
                <div class="kab-success-content" role="status" aria-live="polite">
                    ...
                    <h1 class="kab-success-title">Email changed successfully</h1>
                    ...
                    <p class="kab-success-message">Please sign in with your new email and current password.</p>
